<template>
    <el-drawer :title="drawerTitle" v-model="dialogVisible" direction="rtl" size="70%">
        ...
        <el-form :model="searchForm" size="small"  >
            ...
            <el-form-item>
                ...
                <el-button @reset="resetSearchFrom">重置</el-button>
            </el-form-item>
        </el-form>
        ...
        <el-table :data="tableData" stripe border style="width: 100%" v-loading="loading">
           <template v-if="type==='user'">
            ...
            <el-table-column label="用户信息" prop="username" align="center"  width="100px">
            

            </el-table-column>

            <el-table-column label="推广用户数量" prop="share_num" align="center" width="150px"></el-table-column>
            <el-table-column label="推广订单数量" prop="share_order_num" align="center" width="150px"></el-table-column>
            <el-table-column label="绑定时间" prop="create_time" align="center" width="250px"></el-table-column>
           ...
           <template v-else>
            ...
            <el-table-column label="用户名｜昵称｜手机" align="center"  width="200px">
                <template #default="{ row }">
                    <div v-if="!row.order.user">
                        该用户已被删除
                    </div>
                    <div v-else>
                        {{ row.order.user.username }}|{{  row.order.user.nikename}}|{{  row.order.user.phone}}
                    </div>
            ...
            <el-table-column label="时间" prop="create_time" align="center" width="150px"></el-table-column>
            <el-table-column label="返佣金额" prop="commission" align="center" width="250px"></el-table-column>
...
const { searchForm, tableData, loading, currentPage, total, limit, getData, handleDelete, handleStatusChange } = useInitTable({
    searchForm: {
        type: "all",
        starttime: null,
        endtime: null,
