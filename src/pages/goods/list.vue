    ...
    <div>
        ...
        <el-card shadow="never" class="border-0">
            ...
            <ListHeader layout="create,refresh"  @create="handleCreate"
                @refresh="getData">
                <el-button type="danger" size="small" @click="handleMultiDelete(1)" v-if="searchForm.tab!='delete'">批量删除</el-button>
                <el-button size="small" type="warning" @click="handleRestoreGoods()" v-else>恢复商品</el-button>
            

                <el-popconfirm v-if="searchForm.tab=='delete'" title="是否要彻底删除该商品" confirm-button-text="确认" cancel-button-text="取消"
                                @confirm="handleDestroyeGoods()">
                                <template #reference>
            ...
            <el-table @selection-change="handleSelectionChange" ref="multipleTableRef" :data="tableData" stripe
                ...
                <el-table-column align="center" label="实际销量" width="100" prop="sale_count"></el-table-column>
