...
import { getUserLevelList, createUserLevel, deleteUserLevel, updateUserLevel, updateUserLevelStatus } from "~/api/level"
...
const { formDrawerRef, formRef, form, rules, drawerTitle, handleSubmit, handleCreate, handleEdit } = useInitForm({
  ...
  rules: {
    name: [{ required: true, message: '会员等级名不能为空', trigger: 'blur' },],
