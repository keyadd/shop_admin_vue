    ...
    <div>
        ...
        <el-card shadow="never" class="border-0">
            ...
            <ListHeader layout="refresh,download" @download="handleExportExcel" @refresh="getData">
                <el-button type="danger" size="small" @click="handleMultiDelete(1)">批量删除</el-button>
...
import { toast, showModal,showPrompt} from '~/common/util'

import { useInitTable } from '~/common/useCommon'



const { searchForm, resetSearchFrom, tableData, loading, currentPage, total,onSearch, limit, getData, handleDelete, handleSelectionChange, multipleTableRef, handleMultiDelete, multiSelectIds } = useInitTable({
    searchForm: {
        no: "",
        tab: "all",
        starttime: "",
